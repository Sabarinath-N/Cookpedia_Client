...
export class AddrecipeComponent implements OnInit {
  ...
  constructor(private api: ApiService, private adminapi:AdminApiService, private toastr:ToastrService, private router:Router) { }
  ...
  handleSubmit() {
    ...
    this.adminapi.addRecipeApi(this.recipeData).subscribe({
      next: (res: any) => {
       console.log(res);
      ...
      error: (err: any) => {
        console.log(err);
        this.toastr.error(err.error?err.error:"Recipe Adding Failed !!")
      }
    })
